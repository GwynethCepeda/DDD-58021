...
CREATE TABLE Computer(`SerialNumber` BIGINT NOT NULL, `Make` VARCHAR(12) NOT NULL,
 `Model` VARCHAR(24) NOT NULL, `ProcessorType` VARCHAR(24) NULL,
 `ProcessorSpeed` DOUBLE(3,2) NOT NULL, `MainMemory` VARCHAR(15) NOT NULL,
